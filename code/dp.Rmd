...
Link: <https://datosabiertos.gob.pe/dataset/resultados-por-distrito-de-las-generales-2001-primera-vuelta-oficina-nacional-de-procesos>
...
dataEG01 <- dataEG01 %>% mutate(across(5:8, ~ as.numeric(gsub(",", "", .))))# Deal with comas
```
...
Link: <https://datosabiertos.gob.pe/dataset/resultados-por-distrito-de-las-elecciones-congresales-2001-oficina-nacional-de-procesos>
